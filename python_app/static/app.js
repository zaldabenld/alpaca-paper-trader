...
function readConfig() {
  return {
    ...
    buy_rsi_min: readNumber("buyRsiMin", 40),
    ...
    stop_loss_percent: readNumber("stopLossPercent", 3),
...
function renderDashboard(dashboard) {
  ...
  els.dashboardHaltStatusDetail.textContent = halt.detail || "Subscribed top-volume symbols only.";
